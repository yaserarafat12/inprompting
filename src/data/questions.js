  ...
  creator: [
    {
      ...
      options: [
        ...
        { label: 'Podcast — audio / narasi', value: 'podcast' },
      ],
    ...
    },
    {
      ...
      optionsFn: (ans) => {
        const map = {
          youtube:   [{ label: 'True crime / investigasi', value: 'true crime dan investigasi' }, { label: 'Edukasi / explainer', value: 'edukasi dan explainer' }, { label: 'Entertainment / vlog', value: 'entertainment dan vlog' }, { label: 'Bisnis / finansial', value: 'bisnis dan finansial' }],
          ...
          instagram: [{ label: 'Carousel informatif', value: 'carousel informatif' }, { label: 'Caption storytelling', value: 'caption storytelling' }, { label: 'Promosi produk', value: 'promosi produk' }, { label: 'Engagement / pertanyaan', value: 'engagement' }],
          podcast:   [{ label: 'Interview / talkshow', value: 'interview dan talkshow' }, { label: 'Narasi / storytelling', value: 'narasi storytelling' }, { label: 'Deep dive topik', value: 'deep dive' }, { label: 'News / current events', value: 'news dan current events' }],
        }
    ...
    },
    {
      ...
      optionsFn: (ans) => {
        ...
        if (ans.platform === 'youtube') return [{ label: '5-10 menit', value: '5-10 menit' }, { label: '10-20 menit', value: '10-20 menit' }, { label: '20+ menit', value: '20+ menit' }]
    ...
    },
    {
      ...
      optionsFn: (ans) => {
        const map = {
          ...
          ads:         [{ label: 'Langsung beli / checkout', value: 'konversi pembelian' }, { label: 'Klik ke landing page', value: 'klik ke landing page' }, { label: 'Lead generation', value: 'lead generation' }],
          ...
          artikel:     [{ label: 'Rank di Google (SEO)', value: 'ranking SEO' }, { label: 'Edukasi pembaca', value: 'edukasi' }, { label: 'Brand authority', value: 'brand authority' }],
        }
  ...
  developer: [
      ...
      optionsFn: (ans) => {
        const map = {
          website: [
            ...
            { label: 'E-commerce / toko online', value: 'e-commerce dan toko online' },
          ...
          game: [
            ...
            { label: 'RPG / adventure (Unity/Godot)', value: 'RPG atau adventure game dengan Unity atau Godot' },
    ...
    },
    {
      ...
      optionsFn: (ans) => {
        const map = {
          website: [
            { label: 'React / Next.js', value: 'React dan Next.js' },
          ...
          data_ai: [
            ...
            { label: 'Cloud (AWS/GCP/Azure)', value: 'cloud platform AWS GCP atau Azure' },
          ],
          mobile: [
        ...
        return map[ans.project_type] || [
          { label: 'Python', value: 'Python' },
          { label: 'JavaScript / TypeScript', value: 'JavaScript atau TypeScript' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Butuh database (sebutkan di input)', value: 'butuh database integration' },
  ...
  analyst: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Komparatif — bandingkan beberapa opsi', value: 'analisis komparatif' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Framework SWOT / Canvas', value: 'framework SWOT atau Business Model Canvas' },
      ],
  ...
  anime: [
    {
      ...
      options: [
        ...
        { label: 'Shonen epic — Solo Leveling, JJK, dynamic action', value: 'shonen anime style dynamic action Solo Leveling Jujutsu Kaisen epic' },
        ...
        { label: '90s retro anime — vintage cel, Evangelion, Cowboy Bebop', value: '90s retro anime style vintage cel animation Evangelion Cowboy Bebop aesthetic' },
      ],
    ...
    },
    {
      ...
      ask: () => 'Aspect ratio?',
      options: [
        { label: 'Square 1:1 — profile / avatar', value: '--ar 1:1' },
        { label: 'Portrait 9:16 — wallpaper HP', value: '--ar 9:16' },
        { label: 'Landscape 16:9 — desktop wallpaper', value: '--ar 16:9' },
  ...
  realistic: [
    {
      ...
      options: [
        ...
        { label: 'Street photography — candid, urban, real life', value: 'street photography candid urban real life documentary' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Overcast / diffused — soft, even, moody', value: 'overcast diffused soft even lighting moody atmosphere' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Square 1:1 — Instagram feed', value: '--ar 1:1' },
        { label: 'Portrait 4:5 — Instagram portrait', value: '--ar 4:5' },
        { label: 'Landscape 16:9 — cinematic wide', value: '--ar 16:9' },
      ],
      placeholder: 'atau tulis ratio custom',
    },
  ],
  ...
  threed: [
    {
      ...
      options: [
        ...
        { label: 'Architectural viz — interior/exterior, photorealistic', value: 'architectural visualization 3D render interior exterior photorealistic' },
      ],
    ...
    },
    {
      ...
      ask: () => 'Tipe lighting?',
      options: [
        { label: 'Soft studio — clean, even, product-like', value: 'soft studio lighting clean even product photography 3-point light' },
    ...
    },
    {
      ...
      ask: () => 'Aspect ratio?',
      options: [
        { label: 'Square 1:1 — clean showcase', value: '--ar 1:1' },
        { label: 'Landscape 16:9 — scene / environment', value: '--ar 16:9' },
  ...
  pemandangan: [
    {
      ...
      options: [
        { label: 'Alam epik — gunung, hutan, air terjun megah', value: 'epic nature landscape mountains forest waterfall majestic' },
        ...
        { label: 'Winter / salju — pemandangan beku, sunyi, bersih', value: 'winter snow landscape frozen peaceful pristine' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Midday — cahaya terik, kontras tinggi', value: 'bright midday sunlight high contrast harsh shadows' },
        { label: 'Misty morning — kabut pagi, lembut, dingin', value: 'misty morning fog soft diffused light cool atmosphere' },
        { label: 'Dramatic storm — awan gelap, petir, dramatis', value: 'dramatic stormy sky dark clouds lightning epic atmosphere' },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Oil painting — tekstur cat, klasik, museum quality', value: 'oil painting textured classic museum quality traditional art' },
      ],
    ...
    },
    {
      ...
      ask: () => 'Aspect ratio?',
      options: [
        { label: 'Landscape 16:9 — wallpaper / YouTube thumbnail', value: '--ar 16:9' },
        { label: 'Cinematic 21:9 — ultra wide sinematik', value: '--ar 21:9' },
        { label: 'Square 1:1 — feed Instagram', value: '--ar 1:1' },
  ...
  kartun: [
    {
      ...
      options: [
        ...
        { label: 'Crayon / hand-drawn — childlike, warm, playful', value: 'crayon hand-drawn childlike warm playful textured illustration' },
        { label: 'Sticker / emoji style — cute, rounded, expressive', value: 'sticker style cute rounded expressive emoji-like illustration' },
        { label: 'Pixel art / retro game — 8bit, 16bit, nostalgic', value: 'pixel art retro game 8bit 16bit nostalgic style' },
      ],
    ...
    },
    {
      ...
      ask: () => 'Aspect ratio?',
      options: [
        { label: 'Square 1:1 — feed Instagram / profile picture', value: '--ar 1:1' },
        { label: 'Portrait 9:16 — story / poster vertikal', value: '--ar 9:16' },
        { label: 'Landscape 16:9 — banner / thumbnail', value: '--ar 16:9' },
  ...
  custom: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Fine art — gaya pelukis terkenal', value: 'fine art style inspired by classical or contemporary masters' },
...
export const VIDEO_QUESTIONS = {
  ...
  cinematic: [
    ...
    },
    {
      ...
      options: [
        { label: 'Melancholic & lonely — sedih, sunyi, sendirian', value: 'melancholic lonely somber emotional heavy atmosphere' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Overcast blue — dingin, desaturated, moody', value: 'overcast cold blue desaturated moody cinematic grade' },
        ...
        { label: 'Candle / fire light — hangat, flicker, intimate', value: 'warm candlelight flickering fire intimate low key lighting' },
      ],
  ...
  anime_vid: [
    {
      ...
      options: [
        { label: 'Action sequence — pertarungan, combat, sakuga', value: 'high quality anime action sequence sakuga animation fluid movement' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Ufotable — fluid effects, god rays, Demon Slayer', value: 'Ufotable style fluid effects god rays breathtaking Demon Slayer' },
  ...
  music_vid: [
    ...
    },
    {
      ...
      options: [
        { label: 'Film grain / analog — retro, vintage, 8mm feel', value: 'film grain analog retro vintage 8mm super8 aesthetic' },
  ...
  nature_vid: [
    {
      ...
      options: [
        { label: 'Timelapse — awan bergerak, matahari terbit/benam', value: 'dramatic timelapse clouds moving sun rising setting time compression' },
        ...
        { label: 'Weather event — badai, petir, aurora', value: 'dramatic weather event storm lightning aurora borealis' },
      ],
    ...
    },
    {
      ...
      options: [
        { label: 'Documentary — natural, authentic, David Attenborough', value: 'documentary natural authentic BBC style David Attenborough cinematic' },
  ...
  custom_vid: [
    ...
    },
    {
      ...
      options: [
        { label: 'Melancholic & sad — sedih, rindu, berat', value: 'melancholic sad heavy nostalgic longing atmosphere' },
